...
public class CommonController {
	...
	public String signUpProcess(@ModelAttribute Company company, @ModelAttribute Member member,
			@RequestParam("role") String role,
			@RequestParam(value = "registrationKey", required = false) String registrationKey,
			@RequestParam(value = "businessLicenseFile", required = false) MultipartFile file, Model model) {
		try {
