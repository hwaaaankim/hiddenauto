...
public interface OrderRepository extends JpaRepository<Order, Long> {
	...
	Page<Order> findProductionListByPreferredRangeStatusCheckSorted(@Param("categoryId") Long categoryId,
			@Param("allStatus") boolean allStatus, @Param("statusFilter") OrderStatus statusFilter,
			@Param("start") LocalDateTime start, @Param("end") LocalDateTime end, @Param("sortDir") String sortDir,
			Pageable pageable);
	...
	@Query(value = """
			...
			""", countQuery = """
			    ...
			    WHERE (:categoryId IS NULL OR o.productCategory.id = :categoryId)
			      ...
			      AND (:end IS NULL OR o.createdAt < :end)
			""")
	Page<Order> findProductionListByCreatedRangeStatusCheckSorted(@Param("categoryId") Long categoryId,
			@Param("allStatus") boolean allStatus, @Param("statusFilter") OrderStatus statusFilter,
			@Param("start") LocalDateTime start, @Param("end") LocalDateTime end, @Param("sortDir") String sortDir,
			Pageable pageable);
