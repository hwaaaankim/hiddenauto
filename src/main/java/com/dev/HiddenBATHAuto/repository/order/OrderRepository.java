...
public interface OrderRepository extends JpaRepository<Order, Long> {
    ...
    List<Order> findByTask_RequestedByAndPreferredDeliveryDateBetween(
            Member member,
            LocalDateTime start,
            LocalDateTime end
    );
    ...
    @Query("""
                ...
                WHERE (:category IS NULL OR o.productCategory = :category)
                  ...
                  AND (:end IS NULL OR o.createdAt <= :end)
            """)
    Page<Order> findProductionListByCreatedDate(
            @Param("category") TeamCategory category,
            @Param("status") OrderStatus status,
            @Param("start") LocalDateTime start,
            @Param("end") LocalDateTime end,
    ...
    @Query("""
                ...
                WHERE (:category IS NULL OR o.productCategory = :category)
                  ...
                  AND (:end IS NULL OR o.preferredDeliveryDate <= :end)
            """)
    Page<Order> findProductionListByPreferredDate(
            @Param("category") TeamCategory category,
            @Param("status") OrderStatus status,
            @Param("start") LocalDateTime start,
            @Param("end") LocalDateTime end,
    ...
    @Query("""
                ...
                WHERE (:category IS NULL OR o.productCategory = :category)
                  ...
                  AND (:end IS NULL OR o.createdAt <= :end)
            """)
    List<Order> findAllProductionListByCreatedDate(
            @Param("category") TeamCategory category,
            @Param("status") OrderStatus status,
            @Param("start") LocalDateTime start,
            @Param("end") LocalDateTime end,
    ...
    @Query("""
                ...
                WHERE (:category IS NULL OR o.productCategory = :category)
                  ...
                  AND (:end IS NULL OR o.preferredDeliveryDate <= :end)
            """)
    List<Order> findAllProductionListByPreferredDate(
            @Param("category") TeamCategory category,
            @Param("status") OrderStatus status,
            @Param("start") LocalDateTime start,
            @Param("end") LocalDateTime end,
